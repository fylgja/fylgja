module.exports = {
  ...
  "--lineHeight-5": "1.8",
  "--shadow-strength": "1%",
  "--shadow-color-DEFAULT": "gray",
  "--shadow-color-umbra": "color-mix(in srgb, var(--shadow-color) calc(var(--shadow-strength) + 18%), transparent)",
  "--shadow-color-penumbra": "color-mix(in srgb, var(--shadow-color) calc(var(--shadow-strength) + 12%), transparent)",
  "--shadow-color-ambient": "color-mix(in srgb, var(--shadow-color) calc(var(--shadow-strength) + 10%), transparent)",
  "--shadow-1": [
