...
const utilityProps = {
    ...
    fontSize: {
        ...
        lg: [props.fontSize[3], props.lineHeight[2]],
        xl: [props.fontSize[4], props.lineHeight[2]],
        "2xl": [props.fontSize[5], props.lineHeight[2]],
        "3xl": [props.fontSize[6], props.lineHeight[1]],
